"""
Exercise 20: Loading Fine-tuned Models

In this exercise, you'll learn how to properly load fine-tuned models
with LoRA adapters. This includes:
...
ML Relevance:
    Understanding model loading is crucial for deployment:
...
Your Task:
    1. Implement MockBaseModel and MockLoRAModel for testing
    2. Implement load_base_model() - load and configure base model
    3. Implement load_adapter() - apply LoRA weights
    4. Implement merge_and_unload() - merge LoRA into base
    5. Implement prepare_for_inference() - optimize for generation

Run:
    python tutorials/06-fine-tuning/20_load_finetuned.py
"""
...
class MockLoRALayer:
    ...
    def __call__(self, x: np.ndarray) -> np.ndarray:
        ...
        # Hints:
        # 1. Get base output
        # 2. Calculate LoRA contribution: x @ A.T @ B.T * scaling
        # 3. Return base + lora
        pass
    ...
    def merge_weights(self) -> MockLinearLayer:
        ...
        """
        # Your solution here
        # Hint: merged_weight = base_weight + (B @ A) * scaling
        pass
...
class MockLoRAModel:
    ...
    def __init__(
        ...
        # Your solution here
        # Hints:
        # 1. Store base model and config
        # 2. Initialize empty dict for lora_layers
        pass
...
def load_base_model(
    ...
    # Your solution here
    # Hints:
    # 1. Create MockBaseModel
    # 2. Set is_quantized based on load_in_8bit/load_in_4bit
    # 3. Set device
    # 4. Return model
    pass
...
def load_adapter(
    ...
    """
    # Your solution here
    # Hints (mock implementation):
    # 1. Create MockLoRAModel wrapping base_model
    # 2. Create mock LoRA weights for target modules
    # 3. Add adapters to the model
    # 4. Return the LoRA model
    pass
...
def merge_and_unload(lora_model: MockLoRAModel) -> MockBaseModel:
    ...
    # Your solution here
    # Hints:
    # 1. For each LoRA layer, merge weights into base
    # 2. Return the base model (now with merged weights)
    pass
...
def save_adapter(
    ...
    # Your solution here
    # Hints:
    # 1. Collect all LoRA layer weights
    # 2. Create save info dict
    # 3. Return summary
    pass
...
def memory_footprint(
    ...
    # Your solution here
    # Hints:
    # 1. Count parameters in base model
    # 2. Count parameters in adapter (if provided)
    # 3. Convert to MB (param_count * 4 / 1e6 for float32)
    pass
...
if __name__ == "__main__":
    ...
    merged_output = merged(x)
    # Merged model should give different output than original base
    # (because LoRA weights were merged in)
    # But it should match what the LoRA model gave
    ...
    print("="*50)
    print("\nYou've learned how to load and manage fine-tuned models.")
    print("Key takeaways:")
