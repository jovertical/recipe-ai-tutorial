# Problem 19: Monitoring Training
#
# Implement training monitoring utilities to track progress, detect problems
# early, and make informed decisions about when to stop training.
#
# Example:
...
#   logger.plot_metrics()
#
# ML Relevance: Monitoring is essential for successful training:
